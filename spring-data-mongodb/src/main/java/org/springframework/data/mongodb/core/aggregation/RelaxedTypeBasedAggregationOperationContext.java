...
public class RelaxedTypeBasedAggregationOperationContext extends TypeBasedAggregationOperationContext {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.mongodb.core.aggregation.TypeBasedAggregationOperationContext#getReferenceFor(org.springframework.data.mongodb.core.aggregation.Field)
	 */
	@Override
